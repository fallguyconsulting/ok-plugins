...
story catalog as delivered at the release, the published concept layer,
the ruled public surface, the prior release's published documentation —
never from source, tests, or internal design material.
...
grades of one kind. An assumption is not a trap until measurement
contradicts it; one that holds earns attested silence. See also:
`story-artifact`, `trap`, `assessment`, `surface-ruling`,
...
- The assumption set is re-derived fresh at every release; no standing
