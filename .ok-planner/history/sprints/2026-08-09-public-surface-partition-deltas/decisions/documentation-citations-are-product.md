...
vocabulary: a publishable record points at catalog rows over the ruled
public surface, never at source paths, tests, or internal entry
points. Verification-layer records — the surface ruling, evidence
sets, the experiment archive — cite the tree freely. All citations are
