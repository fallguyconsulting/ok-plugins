...
reach the intake through the judge's confirmation and no other way.
Every one is made ruling-ready
...
read of a determination the first reader would not affirm.
Deduplication against the slugs
...
independent second read that overturns as readily as it confirms: a
remainder is filed only after a bounded loop has failed to
