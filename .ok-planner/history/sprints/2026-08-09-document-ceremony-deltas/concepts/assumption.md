...
story catalog, the published concept layer, the declared surface, the
prior release's published documentation — never from source, tests, or
...
`story-artifact`, `trap`, `assessment`, `documentation-corpus`.
