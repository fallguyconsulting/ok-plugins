...
audit is the ceremony's entire measurement front: it rules the
surface partition, determines story support from the user's side,
...
catalog projected over the ruling's public side, assessments from the
story and assumption determinations, the trap registry from the
assumption dispositions — and its own work is synthesis, projection,
and the mechanical gates. An audit already stamped is not repeated:
