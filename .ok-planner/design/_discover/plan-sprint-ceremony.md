...
- `sprint`, `issue-queue`, `completion-contract`, `transclusion-tokens` (reviewer sharing), `script-materialization` (surface-corpus runs from plugin root).
