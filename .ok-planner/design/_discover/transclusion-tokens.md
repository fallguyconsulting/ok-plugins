...
- Token uses: discover-design (11 tokens across 4 prompts), audit passes 1–2, plan-sprint (§2 proof gate, §4 queue format, §5 reviewer), certify step 5, true-up §3 (reads `{{ISSUE-QUEUE-FORMAT}}`).
