---
name: ok-planner
description: "ONLY activated by explicit slash command (/plan-sprint, /certify-work, /certify-all, /sketch, /ok-planner-audit, /verify-issues, /discover-design, /ok-version). Never auto-triggered by conversation content."
---
