...
The dot-directory layout, cheatsheet, vendored binary, edit hook, and
...
binary, edit hook, and skills match the carried rendering; the budget
baseline's existence and location; the hook wiring in
