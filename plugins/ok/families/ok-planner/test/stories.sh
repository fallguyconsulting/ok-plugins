...
# hook, the converge core — and asserts on what running it produced.
# Static text, code, and prose are left alone; the @story: annotations
# below are navigation, linking each section to the story it exercises.
#
