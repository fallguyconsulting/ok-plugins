...
Annotations carry exactly two jobs — this navigation, and proof
registration (`@story:` on proof artifacts) — and play no part in
certification scope or audit invalidation: what a change puts in
...
hashes or anchors changed (`--list-stale` prints the set); by
...
citation caught. Nominations land as provisional notes in the audit
files; the auditor adjudicates each — promoted into a citation or
dismissed with a reason — and recorded adjudications bind later runs
unless the cited reality moves. Certification also dispositions every
