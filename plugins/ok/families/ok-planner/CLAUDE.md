...
scripts/ok-planner-gitignore      # The estate's own ignore file; keeps generated estate content (the fetched view build, the cost record) out of the repository and out of the source graph
