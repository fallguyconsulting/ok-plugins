---
name: audit
description: "ONLY activated by explicit /audit slash command. A pure reporter over the whole design corpus: compliance, coverage, cross-artifact consistency, surface inventory, and annotation integrity — findings return in-context, nothing is written. Never auto-triggered by conversation content."
---
