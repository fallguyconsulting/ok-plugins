...
- Never move family knowledge into the administrator, and never into a ceremony body. Migration procedures, config walkthroughs, and conflict handling belong in the family's `admin/ADMINISTRATION.md`; deterministic mechanics belong in its `admin/converge`; what a family contributes to planning, certification, or the audit belongs in its `ceremony/<verb>.md`. Discovery markers are documented in `docs/integration-contract.md` — the contract, not this skill, is where the convention lives.
