...
- `/ok-standards:affirm` — install or refresh `.claude/rules/plumbline-cheatsheet.md` from the plugin's canonical version.
- `/ok-standards:audit` — run the lint over the whole project and group findings into a remediation plan.
